/* spheresweep_lanes.pov version 2.1A
 ...
 * transparency.
 *
 * For my nephew Cris, who smoked me at a bowling alley when he was 3 years old.
 *
 ...
 * 1.1   2015-Aug-28  The red check is tweaked.
 * 1.2   2015-Sep-11  A Bezier sweep is demonstrated.
 * 2.0   2020-Sep-09  The red check is made a bit warmer.
 * 2.1   2020-Sep-27  The 'S' Bezier is changed to 2nd degree.
...
{ radial color_map { [0.5 rgb <0.85, 0, 0.05>] [0.5 rgb <1, 0.8, 0>] }
  frequency FREQ
  rotate 90 / FREQ * y
}
...
#declare SPts = array[18]
{ <3.15, 7.6>, <1.85, 9.35>, <0, 9.35>,
  <0, 9.35>, <-3.15, 9.35>, <-3.15, 6.8>,
  <-3.15, 6.8>, <-3.15, 5.356>, <0, 4.6>,
  <0, 4.6>, <3.35, 3.796>, <3.35, 2.4>,
  <3.35, 2.4>, <3.35, -0.35>, <0, -0.35>,
  <0, -0.35>, <-1.9, -0.35>, <-3.35, 1.6>,
}
...
#declare Letters[4] = SphereSweep_Merge (SSWP_BEZIER2_SPLINE, SPts, NeonRs, RES)
